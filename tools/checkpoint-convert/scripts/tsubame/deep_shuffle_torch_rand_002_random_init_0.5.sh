...
#$ -l node_h=1
#$ -l h_rt=2:00:00
#$ -o outputs/convert/upcycle/mixtral-8x1.56B-shuffle_torch_rand_002_random_init_0.5/$JOB_ID
#$ -e outputs/convert/upcycle/mixtral-8x1.56B-shuffle_torch_rand_002_random_init_0.5/$JOB_ID
#$ -p -5
...
BASE_CHECK_POINT_DIR=/gs/bs/tgh-NII-LLM/checkpoints/upcycle-Mixtral-8x1.56B-shuffle_torch_rand_002_random_init_0.5_main_zero3/lr_2e-4-minlr_2e-5_warmup_2000_seq_4096/
OUTPUT_BASE_DIR=/gs/bs/tgh-NII-LLM/zero3_to_fp32/upcycle-Mixtral-8x1.56B-shuffle_torch_rand_002_random_init_0.5_main_zero3/lr_2e-4-minlr_2e-5_warmup_2000_seq_4096/
