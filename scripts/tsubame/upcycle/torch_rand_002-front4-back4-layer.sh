...
#$ -l node_f=4
#$ -l h_rt=384:00:00
#$ -o outputs/upcycle/mixtral-8×1.56b_torch_rand_002-front4-back4-layer/$JOB_ID
#$ -e outputs/upcycle/mixtral-8×1.56b_torch_rand_002-front4-back4-layer/$JOB_ID
#$ -p -5
...
TOKENIZER_MODEL=/gs/bs/tgh-NII-LLM/checkpoints/upcycle-Mixtral-8x1.56B-torch_rand_002-front4-back4-layer/tokenizer.model
CHECKPOINT_DIR=/gs/bs/tgh-NII-LLM/checkpoints/upcycle-Mixtral-8x1.56B-torch_rand_002-front4-back4-layer
CHECKPOINT_SAVE_DIR="/gs/bs/tgh-NII-LLM/checkpoints/upcycle-Mixtral-8x1.56B-torch_rand_002-front4-back4-layer_zero3/lr_${LR}-minlr_${MIN_LR}_warmup_${LR_WARMUP_STEPS}_seq_${SEQ_LENGTH}"
...
JOB_NAME="upcycle-Mixtral-8x1.56B-torch_rand_002-front4-back4-layer-${NODE_TYPE}-${NUM_NODES}node-${NUM_GPUS}gpu-${SEQ_LENGTH}s-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-WARMUP=${LR_WARMUP_STEPS}-WD=${WEIGHT_DECAY}-GC=${GRAD_CLIP}"
